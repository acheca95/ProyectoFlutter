    ...
    pdf.addPage(pw.MultiPage(
      ...
      header: (pw.Context context) {
        ...
        return pw.Container(
            ...
            margin: const pw.EdgeInsets.only(bottom: 3.0 * PdfPageFormat.cm),
            padding: const pw.EdgeInsets.only(bottom: 3.0 * PdfPageFormat.cm),
            decoration: const pw.BoxDecoration(
                border: pw.BoxBorder(
                    bottom: false, width: 0.2, color: PdfColors.grey)),
